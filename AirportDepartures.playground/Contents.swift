...
let flight1 = Flight(departureTime: Date(), terminal: nil, status: .Scheduled)
let flight2 = Flight(departureTime: nil, terminal: "A", status: .Canceled)
let flight3 = Flight(departureTime: Date(), terminal: "B", status: .etc)
